  ...
  return (
    <footer className="w-full pb-10 mb-[100px] md:mb-5" id="contact">
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:amaar5ali@gmail.com">
          <MagicButton
      ...
      <div className="flex items-center md:gap-3 gap-6">
        {socialMedia.map((profile) => (
          ...
          >
            <img
              src={profile.img}
              alt={String(profile.id)} // Had to convert id to string because of type error expecting a string type not number
              width={20}
              height={20}
            />
          </div>
